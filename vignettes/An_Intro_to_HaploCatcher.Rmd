...
The example data set for the HaploCatcher package contains heterozygous calls, so we will perform both models using the "include_hets" argument set to FALSE and TRUE. We will also set n_perms=10 for expediency of models, even though the minimum should be 30.  
